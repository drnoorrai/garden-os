...
export const createSeedData = (date = todayKey()): GardenData => ({
  ...
  workItems: [
    ...
    },
    {
      id: createId(),
      createdAt: date,
      title: "Review design notes with fresh eyes",
      kind: "obligation",
      triage: "defer",
      workspaceId: DEFAULT_PRIVATE_WORKSPACE_ID,
      visibility: "private",
  ...
  relationships: [
    {
      ...
      name: "Maya",
      stage: "active",
      role: "Creator and trusted reviewer",
      notes: [
        { id: createId(), createdAt: date, kind: "idea", body: "Ask Maya to help shape the strongest hook before drafting." },
        { id: createId(), createdAt: date, kind: "note", body: "Review should feel calm and concrete, not like project management." },
      ],
      workspaceId: DEFAULT_PRIVATE_WORKSPACE_ID,
      visibility: "private",
      createdBy: DEFAULT_MEMBER_ID,
    },
    {
      ...
      notes: [
        { id: createId(), createdAt: date, kind: "note", body: "A place for links, outlines, shoots and reusable ideas." },
      ],
      workspaceId: DEFAULT_PRIVATE_WORKSPACE_ID,
      visibility: "private",
      createdBy: DEFAULT_MEMBER_ID,
  ...
  objectNotes: [
    {
      ...
      body: "This moment could become a post about saving the spark before trying to organize it. Ask [[Maya]] for the warmer opening angle.",
      workspaceId: DEFAULT_PRIVATE_WORKSPACE_ID,
      visibility: "private",
      createdBy: DEFAULT_MEMBER_ID,
    },
  ...
  objectRelations: [
    ...
    {
      id: "obj-rel-content-maya",
      from: { kind: "content", id: "content-podcast-to-post" },
      to: { kind: "person", id: "rel-maya" },
      label: "mentions",
      workspaceId: DEFAULT_PRIVATE_WORKSPACE_ID,
    },
  ],
  ...
  objectNextActions: [
    {
      id: "obj-next-content",
      object: { kind: "content", id: "content-podcast-to-post" },
      title: "Draft three hook options before outlining.",
      status: "open",
      workspaceId: DEFAULT_PRIVATE_WORKSPACE_ID,
      visibility: "private",
      createdBy: DEFAULT_MEMBER_ID,
  ...
  taskGardenItems: [
    {
      ...
      notes: "Start with the moment that made Noor pause, then sharpen the hook.",
    ...
    },
    {
      ...
      workspaceId: DEFAULT_PRIVATE_WORKSPACE_ID,
      zone: "develop",
      title: "Shape a content rhythm for the week",
    ...
    },
    {
      ...
      objectRef: { kind: "person", id: "rel-maya" },
      workspaceId: DEFAULT_PRIVATE_WORKSPACE_ID,
      zone: "ask-delegate",
      title: "Ask Maya for a warmer opening angle",
  ...
  bets: [
    ...
    { id: createId(), title: "Household planning", notes: "Revisit after personal flow is proven.", impact: 2, effort: 4, status: "parked" },
  ],
  kanbanCards: [
